...
beq $9, $2, 38    //  if ($9 == $2) goto node_loop_post;
...
beq $8, $3, 20    //  if ($8 == $3) goto edge_loop_post;
add $13, $8, $8   // (x2)
...
nor $4, $4, $11   //  $4 = ~$4 & ~$11;
andi $4, $4, 1    //  $4 = $ & 1;
bne $4, $0, -40   //  if ($4 != 0) goto first; // Search from the first again...
beq $11, $0, -36  //  if ($11 == 0) goto node_try_loop;
